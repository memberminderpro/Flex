package com.sample.model
{
	...
	public class Employee
	{
		...
		public static function createEmployee(fName:String,hDate:Date,lName:String):Employee
		{
			...
			employee.address.street1=getRandom(100,999).toString() + " " + streetNames[getRandom(0,streetNames.length-1)]+ " " + streetTypes[getRandom(0,streetTypes.length-1)];
			employee.address.city=streetNames[getRandom(0,streetNames.length-1)];
			employee.address.state=state.data;
			employee.address.country="USA";
			
			employee.address.apartmentNumber = getRandom(1,15);
			if(employee.address.apartmentNumber==13){
				employee.address.apartmentNumber=NaN;
			}
			else{
				employee.address.street2="Apt " + employee.address.apartmentNumber;
				employee.address.validFrom = new Date(getRandom(2000,2005),getRandom(0,11),getRandom(1,28));
				employee.address.validTo = new Date(getRandom(2005,2010),getRandom(0,11),getRandom(1,28));
			}
